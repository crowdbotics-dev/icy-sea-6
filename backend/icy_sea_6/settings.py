"""
Django settings for icy_sea_6 project.
...
WSGI_APPLICATION = 'icy_sea_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "icy_sea_6 API",
    "DESCRIPTION": "API documentation for icy_sea_6 App",
    "VERSION": "v1",
}
